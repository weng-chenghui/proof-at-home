...
difficulty: medium
conjecture_ids: [fin_binom_001, fin_binom_002]
published: true
ai_annotations:
...
**Conjecture `fin_binom_001`:** *The risk-neutral probability lies in $(0, 1)$.*
...
**Conjecture `fin_binom_002`:** *The Law of One Price -- replicating portfolios have the same initial value.*
...
|---|---|---|
| `fin_binom_001` | Risk-neutral probability $q \in (0,1)$ | Positivity of numerator/denominator, `div_lt_one` |
| `fin_binom_002` | Law of One Price | Subtract equations, use $u \neq d$ and $S_0 \neq 0$ |
